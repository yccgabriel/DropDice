...
{
	this->resources.textures[0] = this->MakeTexture("assets/1.png");
	this->resources.textures[1] = this->MakeTexture("assets/2.png");
	this->resources.textures[2] = this->MakeTexture("assets/3.png");
	this->resources.textures[3] = this->MakeTexture("assets/4.png");
	this->resources.textures[4] = this->MakeTexture("assets/5.png");
	this->resources.textures[5] = this->MakeTexture("assets/6.png");
	this->resources.vertexShader = this->MakeShader(GL_VERTEX_SHADER, "shaders/VertexShader.vert");
	this->resources.fragmentShader = this->MakeShader(GL_FRAGMENT_SHADER, "shaders/FragmentShader.frag");
...
GLuint ShaderManager::MakeTexture(const char *filename)
{
	...
	unsigned int error = lodepng::decode(image, width, height, std::string(filename), LCT_RGB);
